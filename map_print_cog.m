function [y1,y2] = map_print_cog(Data_rms,min,max)

%map figure
Data_rms_maps=Data_rms;
temp = Data_rms_maps(49:59);
Data_rms_maps(49)= (1.4*Data_rms_maps(50)+1.4*Data_rms_maps(37)+Data_rms_maps(38))/3.4;
Data_rms_maps(50:60)= temp;
% % Data_rms_maps(1)=(1.4*Data_rms_maps(2)+1.4*Data_rms_maps(13)+Data_rms_maps(14))/3.4;
...
% % % %axis off
% % % hold on
% % % %plot(y,x,'ko','LineWidth',1);
% % % %highlight the channels used to compute the diff feature (20 and 21 now)
% % % plot(3,6,'ko','LineWidth',3);
% % % plot(3,7,'ko','LineWidth',3);
% % % 
% % % view(0,90)
...
% % % 
% % % plot(ycg,xcg,'x','LineWidth',2,'MarkerSize',10,'MarkerEdgeColor','k')
